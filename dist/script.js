...
/* harmony import */ var _modules_changeImage__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/changeImage */ "./src/js/modules/changeImage.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_changeImage__WEBPACK_IMPORTED_MODULE_8__["default"])('.sizes-block');
...
var accordion = function accordion(trigger, content) {
  var accordionHeading = document.querySelectorAll(trigger),
  ...
  function hideExcept(accordionHeading, target) {
    accordionHeading.forEach(function (el) {
      if (el !== target) {
  ...
  function accordionClick(accordionHeading) {
    accordionHeading.forEach(function (item) {
      item.addEventListener('click', function (event) {
        var save = event.target.parentNode.nextElementSibling;
...
var changeImage = function changeImage(selector) {
  var imageBody = document.querySelectorAll(selector);
  imageBody.forEach(function (image) {
    image.addEventListener('mouseover', function (e) {
      if (e.target.tagName == 'IMG') {
        var defeniteTheImage = e.target.className.slice(-2);
        e.target.src = "assets/img/sizes".concat(defeniteTheImage, "-1.png");
    ...
    image.addEventListener('mouseout', function (e) {
      if (e.target.tagName == 'IMG') {
        var defeniteTheImage = e.target.className.slice(-2);
        e.target.src = "assets/img/sizes".concat(defeniteTheImage, ".png");
...
var drop = function drop() {
  ...
  function highlight(item) {
    ...
    item.closest('.file_upload').style.backgroundColor = 'rgb(0, 0, 0, 0.7)';
  }
...
var filter = function filter() {
  ...
  menu.addEventListener('click', function (e) {
    var selectedClass = e.target.classList[0];

    if (selectedClass == "".concat(btnGrandmother.classList[0]) || selectedClass == "".concat(btnGranddad.classList[0])) {
      var allElements = '';
      typeFilter(allElements);
    } else {
      var _allElements = wrapper.querySelectorAll(".".concat(selectedClass));

      typeFilter(_allElements);
    }
  });
  menu.addEventListener('click', function (e) {
    var target = e.target;
